...
const ProtectedRoute = ({ children }: { children: React.ReactNode }) => {
  ...
  const token = useAuthStore((s) => s.token) || (typeof localStorage !== "undefined" ? localStorage.getItem("auth_token") : null);
        ...
        <TooltipProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/case/:caseId" element={<ProtectedRoute><CaseChat /></ProtectedRoute>} />
