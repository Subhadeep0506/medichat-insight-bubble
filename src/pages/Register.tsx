  ...
  return (
    <div className="h-screen overflow-hidden relative">
      ...
      <div className="h-full w-full flex">
        ...
        <div className="w-full md:w-1/3 flex items-center md:items-start justify-center md:justify-start bg-white">
          <div className="w-full max-w-md items-center justify-center">
              ...
              <div className=" md:block w-full p-6 text-center">
                ...
                <p className="text-slate-600 dark:text-slate-300">Join MediCase to start managing medical cases</p>
              </div>
